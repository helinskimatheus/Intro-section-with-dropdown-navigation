...
function showBackgroundMenuMobile(){
    let showBackground = document.querySelector('.backgroundMenuMobile')
    if(showBackground.classList.contains('addBackGroundMenuMobile')){
        showBackground.classList.remove('addBackGroundMenuMobile')
    }
    else{
        showBackground.classList.add('addBackGroundMenuMobile')
    }
}
